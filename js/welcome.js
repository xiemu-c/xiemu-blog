...
// 进行 fetch 请求
fetch('https://api.nsmao.net/api/ip/query?key=8E3p0PMdWYxCWQ22zJxD8WAmzQ') //申请key:https://api.nsmao.net
.then(response => {
if (!response.ok) {
...
return;
 ...
 let dist = getDistance(118.556965, 36.503821, ipLocation.data.lng, ipLocation.data.lat); // 修改自己的经度（121.413921）纬度（31.089290）
